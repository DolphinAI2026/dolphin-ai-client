...
const localServerRunningAt = 'https://localhost:8084/'
const targetEnv = 'app'
const tenantId = '822201427723026433'
const appId = '806997227284201472'
const outputName = 'form-component-file-upload'
const customWidgetList = [{"code": "FORM_CUSTOM_COMPONENT_FILE_UPLOAD", "text": "file-upload", "description": "file-upload"}]
...
;(async () => {
  ...
  try {
    await page.goto('https://apaas-poc.definesys.cn/platform//account/login', { waitUntil: 'domcontentloaded', timeout: 120000 })
