...
const outputName = 'form-component-approval-flow'
const customWidgetList = [{"code": "FORM_CUSTOM_COMPONENT_APPROVAL_FLOW", "text": "approval-flow", "description": "approval-flow"}]
