...
;(async () => {
  ...
  try {
    ...
    await page.goto('https://apaas-dev8.dfy.definesys.cn/platform//566642786573484033/admin/app-store/edit-app?appId=806997227284201472&currentStepIndex=2', { waitUntil: 'domcontentloaded', timeout: 60000 })
