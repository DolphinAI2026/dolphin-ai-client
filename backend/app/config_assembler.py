...
可用字段类型：单据号(#)、单行输入(T)、多行输入(¶)、手机号码(📱)、电子邮箱(✉)、下拉单选(▼)、下拉多选(☰)、数据单选(🔗)、日期时间(📅)、金额(💰)、数字(123)、附件上传(📎)、开关(⊘)、人员选择(👤)、部门选择(🏢)、地理位置(📍)、子表(▦)
