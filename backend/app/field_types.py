...
_COMPAT_TYPES: Dict[str, FieldTypeInfo] = {
    ...
    "多选框": FieldTypeInfo(
        display_name="多选框", data_model_type="STRING",
        component_type="FORM_SELECT_INPUT", icon="☐", prompt_icon="☐",
        description="多选框",
    ),
    "富文本": FieldTypeInfo(
        display_name="富文本", data_model_type="BIG_TEXT",
        component_type="FORM_TEXTAREA_INPUT", icon="R", prompt_icon="R",
        description="富文本编辑器",
    ),
    "超链接": FieldTypeInfo(
        display_name="超链接", data_model_type="STRING",
        component_type="FORM_TEXT_INPUT", icon="⊕", prompt_icon="⊕",
        description="超链接",
    ),
    "证件号": FieldTypeInfo(
        display_name="证件号", data_model_type="STRING",
        component_type="FORM_TEXT_INPUT", icon="#", prompt_icon="#",
        description="证件号码",
    ),
    "签名": FieldTypeInfo(
