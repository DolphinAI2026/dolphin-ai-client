...
_HEADER_ALIASES: Dict[str, str] = {
    ...
    "目标模型编码": "目标模型编码", "targetmodelcode": "目标模型编码", "target_model_code": "目标模型编码",
    "关联模型编码": "目标模型编码", "ref_model": "目标模型编码", "refmodel": "目标模型编码",
    "目标字段编码": "目标字段编码", "targetfieldcode": "目标字段编码", "target_field_code": "目标字段编码",
    "关联显示字段编码": "目标字段编码", "ref_field": "目标字段编码", "reffield": "目标字段编码",
    # 表单配置
