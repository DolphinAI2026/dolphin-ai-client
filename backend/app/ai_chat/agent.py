...
_SYSTEM_ASSISTANT_INTRO_RESPONSE = (
    "你好，我是睿鲸 AI 的 Code 系统助手。我可以协助四类工作：\n"
    "1. 基于内置脚手架创建本地 Code 种子工程/工作区。\n"
    "2. 在绑定工作区内读写编辑工程文件，生成开发规格或工程草稿。\n"
    "3. 初始化 aPaaS 后端骨架，并运行构建、命令、doctor、lint 和验证。\n"
    "4. 查询知识与 Skill，生成或迭代工作区 Skill 草稿。\n"
    "平台配置、部署发布和数字员工能力暂不开放。"
)
