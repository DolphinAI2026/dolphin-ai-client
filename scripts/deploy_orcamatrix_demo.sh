...
awk '
  !/^(DATABASE_URL|AUTH_PROVIDER|CONTROL_PLANE_BINDING_ENABLED|DOLPHIN_WORKSPACE_BASE_URL|DOLPHIN_CODE_CONTROL_PLANE_URL|DOLPHIN_CODE_CONTROL_PLANE_DELEGATION_SECRET|DOLPHIN_CODE_BUILDER_URL|AI_BUILDER_CHAT_DEEPLINK_BASE|DESKTOP_PUBLIC_BASE_URL|DESKTOP_BUILDER_BASE_URL|DESKTOP_CODE_BASE_URL|HOST|PORT)=/
...
DESKTOP_PUBLIC_BASE_URL=${PUBLIC_BASE_URL}
DESKTOP_BUILDER_BASE_URL=${PUBLIC_BASE_URL}
DESKTOP_CODE_BASE_URL=${CONTROL_PLANE_URL}
HOST=0.0.0.0
PORT=8003
EOF
