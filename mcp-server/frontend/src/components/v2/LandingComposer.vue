<!-- frontend/src/components/v2/LandingComposer.vue
  ...
  - AI Builder: 多文件 (any type) + text → /ai-chat（消费 previewStore.pendingAiChatFiles + ?prompt）
  - AI Coding: text → /coding（进去后 agent 引导选目标应用 + templateType）
...
const MODES: { id: Mode; label: string; sub: string; tone: 'ai' | 'brand' | 'emerald' }[] = [
  ...
  { id: 'coding',  label: 'AI Coding',  sub: '通用组件库 — 跨应用复用',                tone: 'brand' },
...
<style scoped>
.composer { width: 100%; max-width: 100%; margin: 0 auto; }
