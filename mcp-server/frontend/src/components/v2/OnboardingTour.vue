...
const FLOW_STEPS = [
  ...
  { n: '02', label: '生成 SPEC',    tone: 'brand',  desc: 'AI Builder 边对话边产出结构化设计文档' },
...
const CONCEPTS = computed(() => [
  ...
  { name: '组件市场',     desc: 'AI Coding 产出的低代码组件 / 页面 / 接口',       icon: 'store',    count: counts.value.marketplace > 0 ? `${counts.value.marketplace} 个` : '—' },
])

const ROLES = [
  { id: 'business', name: '业务顾问',     tone: 'ai',      desc: '描述需求 → SPEC → 部署',         positions: '实施顾问 / 产品经理',         path: 'AI Builder',     recommended: false },
  { id: 'developer', name: '开发人员',    tone: 'brand',   desc: '业务搭建 ↔ 自研组件',           positions: '前端 / 全栈工程师',           path: 'AI Coding · Vibe Coding', recommended: false },
    ...
    <div v-if="visible" class="onb-overlay" data-design="v2">
      <div class="onb-panel">
        ...
        <section v-if="step === 0" class="onb-body">
          <h2 class="onb-title">欢迎使用睿鲸AI工作台</h2>
        ...
        <section v-if="step === 1" class="onb-body">
          ...
          <p class="onb-subtitle">4 个核心概念，构成睿鲸AI工作台的工作单元。</p>
