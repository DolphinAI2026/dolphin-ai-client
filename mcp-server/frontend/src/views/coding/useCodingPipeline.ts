...
export interface PipelineDeps {
  ...
  onIdeAvailable?: () => void
  onConversationUpdated?: (conversationId: number | null) => void | Promise<void>
}
...
export function useCodingPipeline(deps: PipelineDeps) {
  ...
  const sseHandlers: Record<string, (parsed: any) => void | Promise<void>> = {
    ...
    scene_detected: (parsed) => {
      ...
      await onConversationUpdated?.(parsed.conversation_id || null)
  ...
  async function uploadAttachmentIfPresent(
    ...
    if (file.name.toLowerCase().endsWith('.zip')) {
      return `${message}\n\n[\u9644\u4EF6\u7EC4\u4EF6\u5305: ${uploadResult.filename}, \u5DF2\u4FDD\u5B58\u81F3: ${uploadResult.file_path}]\n\u8BF7\u89E3\u6790\u8FD9\u4E2A zip \u5305\u5E76\u6309\u6211\u7684\u8981\u6C42\u8FDB\u884C\u4E8C\u6B21\u8C03\u6574\u6216\u751F\u6210\u5DE5\u4F5C\u533A\u3002`
    }
