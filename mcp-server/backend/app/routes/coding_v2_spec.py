...
端点（架构文档 § 4.5）：
- GET    /api/coding/v2/specs/{spec_id}          获取完整 Spec envelope
- GET    /api/coding/v2/specs/{spec_id}/versions 获取版本历史
- POST   /api/coding/v2/specs/{spec_id}/confirm  确认 Spec → 触发 Phase SCAFFOLD/GENERATE
- POST   /api/coding/v2/specs/{spec_id}/refine   基于当前 draft 让 AI 再优化（stub → 走 brainstorm）
- POST   /api/coding/v2/specs/{spec_id}/rollback 回滚到某历史版本（生成新版本）
...
router = APIRouter(prefix="/coding/v2/specs", tags=["Coding V2 Spec"])
...
# ══════════════════════════════════════════════════════════════
# GET /coding/v2/specs/{id}/versions
# ══════════════════════════════════════════════════════════════
...
# ══════════════════════════════════════════════════════════════
# POST /coding/v2/specs/{id}/confirm
# ══════════════════════════════════════════════════════════════
...
# ══════════════════════════════════════════════════════════════
# POST /coding/v2/specs/{id}/refine
# ══════════════════════════════════════════════════════════════
...
# ══════════════════════════════════════════════════════════════
# POST /coding/v2/specs/{id}/rollback
# ══════════════════════════════════════════════════════════════
