...
def _classify_tool(name: str) -> tuple[str, str]:
    ...
    # 应用生命周期
    if name in (
        "save_design_draft", "get_draft_summary", "promote_draft_to_app",
        "patch_design_draft", "apply_draft_to_live_app",
        "list_my_applications", "get_application", "list_apaas_apps",
