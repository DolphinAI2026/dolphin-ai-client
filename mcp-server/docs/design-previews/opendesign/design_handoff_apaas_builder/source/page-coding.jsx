// 睿鲸 AI Coding — pure chat-led low-code component generation.
//
// PRODUCT INTENT (vs Vibe Coding):
...
function CodingPage() {
      ...
      <aside className="whale-left">
        ...
        <div className="whale-left-foot">
          <div className="whale-tip">
            <I.book size={13} />
            <div>
              <b>睿鲸 ≠ Vibe Coding：</b>这里你只用聊天，AI 生成 UMD 包并发布到组件市场。需要编辑代码请去 <a style={{ color: 'var(--brand-text)', cursor: 'pointer', textDecoration: 'underline' }} onClick={() => navigate('/vibe')}>Vibe Coding</a>。
            </div>
          </div>
        </div>
      </aside>
      ...
      <main className="whale-main">
              ...
              <div>
                ...
                <div className="whale-status-meta">
                  ...
                  <button className="vibe-sbx-chip" onClick={() => navigate('/runtime')} title="查看沙箱详情">
                    <I.cloud size={10} />
                    <span><b>sbx-7f3a</b> · 2C/4G · 剩余 1h 58m</span>
                  </button>
                  <span>·</span>
        ...
        <div className="whale-chat">
            ...
            m.isToolStatus ? (
              ...
              <div key={i} className={`whale-msg ${m.role === 'user' ? 'whale-msg-user' : ''}`}>
                ...
                <div className="whale-msg-body">
                  <div className="whale-msg-name">{m.role === 'user' ? 'marshub' : 'aPaaS Builder · 睿鲸'}</div>
          ...
          <div className={`whale-msg`}>
            ...
            <div className="whale-msg-body">
              <div className="whale-msg-name">aPaaS Builder · 睿鲸</div>
          ...
          <div className="whale-composer-box">
            ...
            <div className="whale-composer-foot">
              <div style={{ display: 'flex', gap: 4 }}>
                ...
                <button className="icon-btn" title="MCP"><I.mcp size={14} /></button>
              </div>
  ...
  --target=apaas-form-component`}</code></pre>
            ...
            <div style={{ display: 'flex', gap: 6, paddingTop: 12, borderTop: '1px solid var(--border)', flexWrap: 'wrap' }}>
              ...
              <span className="badge badge-outline">aPaaS Builder ≥ 4.2</span>
            </div>
          </div>
        )}
      </aside>
