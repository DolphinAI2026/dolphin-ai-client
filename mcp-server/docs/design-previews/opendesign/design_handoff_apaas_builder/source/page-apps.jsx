      ...
      <div className="page-pad">
        <div className="page-head">
          <div>
            ...
            <div className="page-subtitle">所有已搭建、生成中或草稿状态的 aPaaS 应用。可点击进入对话页继续完善。</div>
          </div>
            ...
            {filtered.map(a => (
              <article key={a.id} className="app-card card card-interactive" onClick={() => navigate('/chat?app=' + a.id)}>
                <div className="app-card-head">
                  ...
                  <button className="icon-btn" onClick={(e) => e.stopPropagation()} title="更多" style={{ width: 28, height: 28 }}>
                    <I.more size={14} />
                  </button>
                </div>
                ...
                <div className="app-card-foot">
                  ...
                  <div style={{ display: 'flex', gap: 4 }} onClick={(e) => e.stopPropagation()}>
                    ...
                    {(a.status === 'draft' || a.status === 'failed') && (
                      <button className="icon-btn" title="开始生成"><I.play size={12} /></button>
                    )}
