...
create_backend_secret() {
  ...
  append_env SYSTEM_GIT_DEFAULT_PROVIDER "$SYSTEM_GIT_DEFAULT_PROVIDER"
  append_env SYSTEM_GIT_DEFAULT_HOST "$SYSTEM_GIT_DEFAULT_HOST"
  append_env SYSTEM_GIT_DEFAULT_ACCESS_TOKEN "$SYSTEM_GIT_DEFAULT_ACCESS_TOKEN"
  append_env SYSTEM_GIT_DEFAULT_GROUP_OR_ORG "$SYSTEM_GIT_DEFAULT_GROUP_OR_ORG"
