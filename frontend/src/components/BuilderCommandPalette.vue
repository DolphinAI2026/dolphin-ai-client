...
const commandItems = [
  { icon: HomeFilled, title: '新建协同构建', meta: '回到首页，用真实 AI Builder 生成设计文档', to: '/' },
  { icon: ChatDotRound, title: 'Chat 工作台', meta: '继续现有搭建对话和部署流程', to: '/chat' },
  ...
  { icon: Monitor, title: 'IDE', meta: '进入真实 AI Coding 工作区', to: '/coding' },
