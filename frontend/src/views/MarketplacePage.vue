  ...
  <div class="marketplace-page">
    ...
    <div class="mp-toolbar">
      ...
      <el-select v-model="selectedCategory" placeholder="全部分类" clearable class="mp-category" @change="loadComponents">
        ...
        <el-option label="表单组件" value="form-component-dual" />
...
function categorySvg(cat: string): string {
  ...
  const svgs: Record<string, string> = {
    'form-component-dual': `<svg width="22" height="22" viewBox="0 0 24 24" fill="none">${grad}<path d="M3.5 3.5H10.5V10.5H3.5V3.5ZM13.5 3.5H20.5V10.5H13.5V3.5ZM3.5 13.5H10.5V20.5H3.5V13.5ZM16 13.5V20.5M13 17H19" stroke="url(#catG)" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></svg>`,
